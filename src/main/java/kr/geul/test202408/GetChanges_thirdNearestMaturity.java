...
public class GetChanges_thirdNearestMaturity {
	...
	static File sourceFolder = new File("c:/test/impliedDividend_thirdNearestMaturity"), targetFile = new File("c:/test/changes_thirdNearestMaturity.csv"), dayTFile, dayTMinusOneFile;	
