...
public class GetChanges_excessDividend_secondNearestMaturity {
	...
	static File sourceFolder = new File("c:/test/impliedDividend_secondNearestMaturity"), targetFile = new File("c:/test/changes_excessDividend_secondNearestMaturity.csv"), dayTFile, dayTMinusOneFile;	
