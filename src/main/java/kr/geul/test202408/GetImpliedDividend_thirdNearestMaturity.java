...
public class GetImpliedDividend_thirdNearestMaturity {
	...
	static double rfr;
	static String targetFolderPath = "c:/test/impliedDividend_thirdNearestMaturity/";
	...
	private static String getTargetMaturity() {
		...
		if (ChronoUnit.DAYS.between(optionTransactionList.get(0).getTransactionDate(), maturityList.get(0)) >= 7)
			...
			return maturityList.get(3).format(formatter);
