...
public class GetChanges_excessDividend {
	...
	static File sourceFolder = new File("c:/test/impliedDividend"), targetFile = new File("c:/test/changes_excessDividend.csv"), dayTFile, dayTMinusOneFile;	
